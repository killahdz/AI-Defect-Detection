...
model = YOLO("yolov8m.pt")  # "yolov8m.pt" for better accuracy
...
pt_save_path = "C:/training/kaggle/models/wood_defect_yolov8m.pt"
...
onnx_save_path = "C:/training/kaggle/models/wood_defect_yolov8m.onnx"
try:
